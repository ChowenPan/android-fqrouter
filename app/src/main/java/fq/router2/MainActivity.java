...
//                gaTracker.sendEvent("more-power", "click", "", new Long(0));
            ...
            if (ASK_VPN_PERMISSION == requestCode) {
                if (resultCode == RESULT_OK) {
                    if (LaunchService.SOCKS_VPN_SERVICE_CLASS == null) {
                        ...
                        updateStatus(getStr(R.string.status_launch_vpn), 80);
                    ...
                    onHandleFatalError(getStr(R.string.status_vpn_rejected));
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        addMenuItem(menu, ITEM_ID_EXIT, getStr(R.string.menu_exit));
    ...
    private void openAbout() {
        ...
        web.loadUrl(getStr(R.string.about_page));
        ...
        new AlertDialog.Builder(this)
                .setTitle(String.format(getStr(R.string.about_info_title), LaunchService.getMyVersion(this)))
                .setCancelable(false)
                .setPositiveButton(R.string.about_info_share, new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialogInterface, int i) {
                        ...
                        intent.putExtra(Intent.EXTRA_SUBJECT, getStr(R.string.share_subject));
                        if (null == shareUrl || shareUrl.trim().isEmpty()) {
                            shareUrl = "https://s3-ap-southeast-1.amazonaws.com/fqrouter/fqrouter-latest.apk";
                        }
                        intent.putExtra(Intent.EXTRA_TEXT, String.format(getStr(R.string.share_content), shareUrl));
                        startActivity(Intent.createChooser(intent, getStr(R.string.share_channel)));
                    }
                })
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                try {
                    shareUrl = DnsUtils.resolveTXT(getStr(R.string.share_url_domain));
                } catch (Exception e) {
    ...
    public void exit() {
        ...
        displayNotification(this, getStr(R.string.status_exiting));
    }
    ...
    public void onLaunched(boolean isVpnMode) {
        ...
        if (isVpnMode) {
            updateStatus(getStr(R.string.status_acquire_vpn_permission), 75);
    ...
    public void onReady() {
        isReady = true;
        ActivityCompat.invalidateOptionsMenu(this);
        updateStatus(getStr(R.string.status_ready), 100);
        displayNotification(this, getStr(R.string.status_ready));
        ...
        new AlertDialog.Builder(this)
                ...
                .setPositiveButton(R.string.new_version_alert_yes, new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        updateStatus(getStr(R.string.status_downloading) + " " + Uri.parse(upgradeUrl).getLastPathSegment(), 5);
    ...
    public void onDownloadFailed(final String url, String downloadTo) {
        ActivityCompat.invalidateOptionsMenu(this);
        onHandleFatalError(getStr(R.string.status_download_failed) + " " + Uri.parse(url).getLastPathSegment());
    ...
    public void onDownloaded(String url, String downloadTo) {
        downloaded = true;
        ActivityCompat.invalidateOptionsMenu(this);
        updateStatus(getStr(R.string.status_downloaded) + " " + Uri.parse(url).getLastPathSegment(), 5);
        onExiting();
        try {
            ManagerProcess.kill();
        } catch (Exception e) {
    ...
    public void onDownloading(String url, String downloadTo, int percent) {
        if (System.currentTimeMillis() % (2 * 1000) == 0) {
            displayNotification(this, getStr(R.string.status_downloading) + " " + Uri.parse(url).getLastPathSegment() + ": " + percent + "%");
        }
        TextView textView = (TextView) findViewById(R.id.statusTextView);
        textView.setText(getStr(R.string.status_downloaded) + " " + percent + "%");
    }
    ...
    public void onExiting() {
        ...
        TextView statusTextView = (TextView) findViewById(R.id.statusTextView);
        statusTextView.setText(getStr(R.string.status_exiting));
    }
